...
# Currently, a uniform freq. distribution over words in dict, and Ngram=1 is set to  attempt to nullify the effect of LM, and to base the recognition decision purely on 
